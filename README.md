# Адаптивная, компонентная pixel-perfect верстка коллективного блога с мобильной версией на основе psd-макета

#### Страница проекта: [https://encrypticus.github.io/pasco/](https://encrypticus.github.io/pasco/)

***Чтобы скопировать репозиторий на свой компьютер, в консоли наберите ```git clone https://github.com/encrypticus/law.git```***
